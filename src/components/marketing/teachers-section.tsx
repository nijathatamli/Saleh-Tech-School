...
export async function TeachersSection() {
  ...
  return (
    <section id="teachers" className="relative overflow-hidden bg-grey-50 px-6 py-32 dark:bg-zinc-900 md:px-20">
      ...
      <div className="absolute right-24 top-16 h-1.5 w-1.5 rounded-full bg-blue-400" />
      <div className="absolute right-10 top-40 h-1 w-1 rounded-full bg-blue-300" />
      <div className="absolute bottom-24 left-16 h-1.5 w-1.5 rounded-full bg-blue-400" />
      <div className="absolute bottom-40 right-1/3 h-1 w-1 rounded-full bg-blue-300" />
