      ...
      <div className="mx-auto grid max-w-6xl gap-6 md:grid-cols-5">
        {steps.map((s, i) => (
          <Reveal key={s.title} delay={i * 100} className="relative flex flex-col items-center text-center">
            ...
            <div className="relative z-10 flex h-16 w-16 items-center justify-center rounded-2xl bg-primary text-white shadow-lg shadow-primary/30 transition-transform duration-300 hover:scale-110 hover:rotate-3">
